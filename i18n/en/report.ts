...
export const report = {
  ...
  sharesNote:
    'Moving money to investing is not spending, and bringing it back is not saving: the money only changed place. It still moved in and out of your goals, so it counts towards what they grew by.',
  borrowNote:
